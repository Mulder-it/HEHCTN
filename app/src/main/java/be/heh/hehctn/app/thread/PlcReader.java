...
import be.heh.hehctn.simanticS7.S7OrderCode;
...
public class PlcReader implements Runnable{
    ...
    public PlcReader(LinearLayout linearLayout, Class enumClass,
    ...
    public void run() {
        ...
        while (isConnected == 0) {
            ...
            for (int i = 0; i < countChild; i++) {
                ...
                DBInterface DBpills = (DBInterface) Enum.valueOf(enumClass, ll.getTag().toString());
                int db = DBpills.getDb();
                int dbb = DBpills.getDbb();
